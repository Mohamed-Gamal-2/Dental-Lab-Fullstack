...
console.log(form)
  ...
  loginAdmin(form: any) {
    ...
    if (form.valid) {
    this.lR.loginAdmin(form.value.adminUsername, form.value.adminPassword).subscribe({
      next: (response : any) => {
  ...
  loginManager(form: any) {
    ...
    console.log("form valid",form.valid)
    if (form.valid) {
    this.lR.loginManager(form.value.managerUsername, form.value.managerPassword).subscribe({
      next: (response : any) => {
